...
![](https://github.com/netology-code/aqa-homeworks/raw/aqa4/selenide/pic/dropdown.png)

2. Выбор даты на неделю вперёд (начиная от текущей даты) через инструмент календаря:

![](https://github.com/netology-code/aqa-homeworks/raw/aqa4/selenide/pic/calendar.png)
